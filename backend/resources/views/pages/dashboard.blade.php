                  ...
                  {{ csrf_field() }}
                    <div class="row">
                      ...
                      <div class="input-field col s12">
                        <input placeholder="ex: Diethanolamine" id="product_name" name="product_name" type="text" class="validate">
                      ...
                      <div class="input-field col s12">
                        <input placeholder="ex: Diethanolamine" id="product_concentration" name="product_concentration" type="text" class="validate">
