...
<div class="grey lighten-5">
	<div class="parallax-container grey-text lighten-2">
		<div class="container">
			<div class="section">
				...
				{{ csrf_field() }}
					<div class="row">
						<div class="input-field col s12 m4 l10 ">
							<input placeholder="Product Name" id="product_name" name="product_name" type="text" style="margin-top: 10px;" class="validate  searchLabel">
