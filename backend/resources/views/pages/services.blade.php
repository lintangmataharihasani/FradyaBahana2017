  ...
  <div class="container">
    <div class="section">
     ...
     <ul class="collapsible popout" data-collapsible="accordion">
         <li>
            <div class="collapsible-header"><img src="images/flasks.png" style="width: 30px;height: 30px; margin-top: 10px;" /><span class="pull-right">Chemicals Supply Management</span>               
            </div>
         ...
         <li><!-- <div class="collapsible-header"><i class="material-icons">filter_drama</i>Chemicals Supply Management</div> -->
